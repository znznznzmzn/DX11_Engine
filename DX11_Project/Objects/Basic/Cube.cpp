...
void Cube::setVertex() {
	...
	float d2 = 0.5f;
	// front
	vertices.emplace_back(VertexType(-w2, -h2, -d2,  0,1,  0,0,-1));
	vertices.emplace_back(VertexType(-w2, +h2, -d2,  0,0,  0,0,-1));
	vertices.emplace_back(VertexType(+w2, +h2, -d2,  1,0,  0,0,-1));
	vertices.emplace_back(VertexType(+w2, -h2, -d2,  1,1,  0,0,-1));
	// back
	vertices.emplace_back(VertexType(-w2, -h2, +d2,  1,1,  0,0,+1));
	vertices.emplace_back(VertexType(+w2, -h2, +d2,  0,1,  0,0,+1));
	vertices.emplace_back(VertexType(+w2, +h2, +d2,  0,0,  0,0,+1));
	vertices.emplace_back(VertexType(-w2, +h2, +d2,  1,0,  0,0,+1));
	// top
	vertices.emplace_back(VertexType(-w2, +h2, -d2,  0,1,  0,+1,0));
	vertices.emplace_back(VertexType(-w2, +h2, +d2,  0,0,  0,+1,0));
	vertices.emplace_back(VertexType(+w2, +h2, +d2,  1,0,  0,+1,0));
	vertices.emplace_back(VertexType(+w2, +h2, -d2,  1,1,  0,+1,0));
	// bottom
	vertices.emplace_back(VertexType(-w2, -h2, -d2,  1,1,  0,-1,0));
	vertices.emplace_back(VertexType(+w2, -h2, -d2,  0,1,  0,-1,0));
	vertices.emplace_back(VertexType(+w2, -h2, +d2,  0,0,  0,-1,0));
	vertices.emplace_back(VertexType(-w2, -h2, +d2,  1,0,  0,-1,0));
	// left	
	vertices.emplace_back(VertexType(-w2, -h2, +d2,  0,1,  -1,0,0));
	vertices.emplace_back(VertexType(-w2, +h2, +d2,  0,0,  -1,0,0));
	vertices.emplace_back(VertexType(-w2, +h2, -d2,  1,0,  -1,0,0));
	vertices.emplace_back(VertexType(-w2, -h2, -d2,  1,1,  -1,0,0));
	// right
	vertices.emplace_back(VertexType(+w2, -h2, -d2,  0,1,  +1,0,0));
	vertices.emplace_back(VertexType(+w2, +h2, -d2,  0,0,  +1,0,0));
	vertices.emplace_back(VertexType(+w2, +h2, +d2,  1,0,  +1,0,0));
